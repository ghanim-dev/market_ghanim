          ...
          -->
					...
					<div class="flex-w w-full p-b-50">
						...
						<div class="size-212">
							...
							<p class="stext-115 cl1 size-213">
								<a class="cl1" href="mailto:ghanimsuksessentosa@gmail.com">ghanimsuksessentosa@gmail.com</a>
							</p>
						</div>
					</div>
					...
					<div class="flex-w w-full">
						...
						<a href="https://fb.me/ghanimss" class="icon-circle txt-center size-211 m-r-10" target="_blank" title="Facebook">
							<i class="fa fa-facebook"></i>
						</a>
						<a href="https://instagram.com/ghanimss" class="icon-circle txt-center size-211 m-r-10" target="_blank" title="Instagram">
