...
$keywords = "";
$img = (isset($img)) ? $img : base_url("ghanim/assets/img/".$set->favicon);
...
<head>
	...
	<link rel="shortcut icon" type="image/png" href="<?=base_url("ghanim/assets/img/".$set->favicon)?>"/>
		...
		<nav class="navbar navbar-expand-lg navbar-light fixed-top">
			<div class="container">
				<a class="navbar-brand" href="<?=site_url()?>">
					<img src="<?= base_url('ghanim/assets/img/'.$set->logo) ?>" height="60" />
				</a>
				<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarToggler" aria-controls="navbarToggler" aria-expanded="false" aria-label="Toggle navigation">
					<!-- <span class="navbar-toggler-icon"></span> -->
					<i class="fas fa-solid fa-align-right" style="color:white"></i>
				</button>
