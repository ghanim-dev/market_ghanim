					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
							...
							?>
								<div class="prod-preview">
									<img src="<?php echo base_url("ghanim/uploads/".$res->nama); ?>" alt="IMG-PRODUCT" id="prod-img">
								</div>
							...
							?>
									<div class="prod-thumb-item" data-thumb="<?php echo base_url("ghanim/uploads/".$res->nama); ?>" style="background-image:url('<?php echo base_url("ghanim/uploads/".$res->nama); ?>');"></div>
							<?php
