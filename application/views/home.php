    ...
    <div class="carousel slider">
		...
		?>
			<div class="slider-item" style="cursor:pointer;" data-onclick="<?=$s->link?>">
				<div class="wrap">
					<img src="<?= base_url('ghanim/promo/'.$s->gambar) ?>" />
				</div>
			</div>
		<?php
				}
	...
	<section class="banner p-t-40 p-b-40 m-b-40">
		<div class="container">
			...
			?>
				<div class="cat-item">
					<div class="cat-bg" style="background-position:center center;background-image:url('<?=base_url("ghanim/kategori/".$r->icon)?>');background-size:cover;" onclick="window.location.href='<?=site_url("kategori/".$r->url)?>'">
					</div>
	...
	<section class="banner m-b-40 playstore-section m-b-40">
		<div class="container center">
			<div class="row">
				...
				<div class="col-md-4">
					<a href="<?=base_url("Ghanimstore.apk")?>" class="playstore">
			...
			<div class="row">
				...
				?>
					<div class="col-md-4 iklans m-b-20">
						<a href="<?=$iklan->link?>">
							<img src="<?= base_url('ghanim/promo/'.$iklan->gambar) ?>" />
						</a>
					</div>
				<?php
					}
					...
					<div class="testimoni-wrap">
						...
						<div class="row m-lr-0">
							<div class="col-3 p-lr-0">
								<div class="testimoni-img" style="background-position:center center;background-image:url('<?=base_url("ghanim/uploads/".$r->foto)?>');background-size:cover;"></div>
							</div>
				...
				<div class="col-md-6 blog-wrap">
					<div class="blog row" onclick="window.location.href='<?=site_url('blog/'.$res->url)?>'">
						<div class="col-4 p-l-0 p-r-0">
							<div class="img" style="background-image: url('<?=base_url("ghanim/uploads/".$res->img)?>')"></div>
						</div>
						<div class="col-8">
							<div class="titel">
	...
	<div id="toaster" class="toaster row col-md-4" style="display:none;">
		<div class="col-3 img p-lr-6"><img id="toast-foto" src="<?=base_url("ghanim/uploads/520200116140232.jpg")?>" /></div>
